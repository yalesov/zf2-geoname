...
class GeonameTest extends DoctrineTestcase
{
    ...
    {
        $cli = $this->sm->get('Yalesov\Cli\Cli')
            ->setTemplates(array(
                'section' => array(
                    'template'  => '## %s ##',
                    'color'     => 'YELLOW',
    ...
    {
        $metaRepo = $this->em
            ->getRepository('Yalesov\Geoname\Entity\Meta');
    ...
    public function testRun()
    {
        ...
        foreach ($stageMap as $curStatus => $data) {
            ...
            $geoname = $this->getMock(
                'Yalesov\Geoname\Service\Geoname',
                array(
                    'downloadUpdate',
                    'installDownload',
                    'installPrepare',
    ...
    {
        $featureRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\Feature');
    ...
    {
        $placeRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\Place');
    ...
    {
        $countryRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\Country');
        $currencyRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\Currency');
        $localeRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\Locale');
    ...
    {
        $timezoneRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\Timezone');
...
return;
    ...
    {
        $altNameRepo =
            $this->em->getRepository('Yalesov\Geoname\Entity\AltName');
