<?php
namespace Yalesov\Geoname\Service;
...
class Geoname
{
    ...
    public function getMeta()
    {
        $em = $this->getEm();
        $repo =
            $em->getRepository('Yalesov\Geoname\Entity\Meta');
    ...
    public function installPlace()
    {
        $em = $this->getEm();
        $featureRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Feature');
    ...
    public function installCountryCurrencyLocale()
    {
        $em = $this->getEm();
        $placeRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Place');
        $languageRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Language');
        $currencyMap = array();
        $localeMap = array();
        $languageMap = array();
        $continentMap = array(
    ...
    public function installTimezone()
    {
        $em = $this->getEm();
        $countryRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Country');
    ...
    public function installPlaceTimezone()
    {
        ...
        $placeRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Place');
        $timezoneRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Timezone');
        $countryRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Country');
    ...
    public function updateAltNameModify()
    {
        $em = $this->getEm();
        $altNameRepo =
            $em->getRepository('Yalesov\Geoname\Entity\AltName');
        $placeRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Place');
        $languageRepo =
            $em->getRepository('Yalesov\Geoname\Entity\Language');
